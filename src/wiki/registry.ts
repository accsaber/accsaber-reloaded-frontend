    ...
    entries: [
      {
        ...
        related: ['weighted-ap', 'what-is-accsaber', 'score-history'],
        updated: '2026-08-03',
      ...
      },
      {
        ...
        related: ['weighted-ap', 'categories', 'score-history', 'xp-and-levels'],
        updated: '2026-08-05',
      ...
      },
      {
        ...
        related: ['weighted-ap', 'xp-and-levels', 'accuracy-and-ap', 'getting-your-scores-counted'],
        updated: '2026-08-05',
    ...
    entries: [
      {
        ...
        related: ['missions', 'score-history', 'leaderboards'],
        updated: '2026-08-04',
      ...
      },
      {
        ...
        related: ['xp-and-levels', 'weighted-ap', 'score-history'],
        updated: '2026-08-04',
